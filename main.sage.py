...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_10 = Integer(10); _sage_const_100 = Integer(100); _sage_const_2 = Integer(2); _sage_const_50 = Integer(50); _sage_const_20 = Integer(20); _sage_const_0p9 = RealNumber('0.9'); _sage_const_60 = Integer(60)
...
def analyze_and_save_graphs(graphs, properties_file='data/grafi.csv', graphs_file='data/grafi_oblika.csv'):
    ...
    if total_to_process == _sage_const_0 :
    ...
    processed = _sage_const_0 
    
    # Obdelaj samo grafe, ki potrebujejo obdelavo
    for i, graf_ime in enumerate(graphs_to_process):
        processed += _sage_const_1 
        if processed % _sage_const_10  == _sage_const_0 :
            percentage = float(_sage_const_100  * processed) / float(total_to_process)
        ...
        if i % _sage_const_50  == _sage_const_0  and i > _sage_const_0 :
...
graphs = generate_random_connected_graphs(_sage_const_20 , _sage_const_10 , _sage_const_0p9 )

# Process each graph individually with predict_alfas
print(f"Processing {len(graphs)} graphs...")
for i, G_data in enumerate(graphs):
    print(f"\n{'='*_sage_const_60 }")
    print(f"Processing graph {i+_sage_const_1 }/{len(graphs)}")
    print(f"{'='*_sage_const_60 }")
    
    # Extract graph from tuple (G, name, family)
    if isinstance(G_data, tuple):
        G = G_data[_sage_const_0 ]  # First element is the graph
    else:
