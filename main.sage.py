...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_20 = Integer(20)
...
graphs = generate_graph_family(graphs.CompleteGraph, "K", "polni", _sage_const_1 , _sage_const_20 )
