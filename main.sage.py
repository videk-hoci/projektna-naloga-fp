...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_10 = Integer(10); _sage_const_100 = Integer(100); _sage_const_2 = Integer(2); _sage_const_50 = Integer(50); _sage_const_7 = Integer(7)
...
def analyze_and_save_graphs(graphs, properties_file='data/grafi.csv', graphs_file='data/grafi_oblika.csv'):
    ...
    for i, (graf_ime, graf_data) in enumerate(all_graphs.items()):
        ...
        if processed % _sage_const_10  == _sage_const_0 :
            percentage = float(_sage_const_100  * processed) / float(total_graphs)
...
graphs = generate_all_graphs_up_to_n(_sage_const_7 )
